...
carg = -I$(cur_dir)/include -I$(cur_dir)/nolib/include -I$(cur_dir)/fdt/include -nostdinc -nostdlib -nolibc -nodefaultlibs -fno-stack-protector  -fno-omit-frame-pointer -Wall -Wextra -c -g
...
obj = main.o entry64.o cache64.o pagetable64.o exceptions.o trap.o $(obj-dev) $(obj-fdt) $(obj-nolib)
